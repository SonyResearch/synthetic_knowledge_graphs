...
parser = argparse.ArgumentParser(description="Generate and save the FTREE dataset.")
parser.add_argument("--n_t", type=int, default=2, help="Number of family trees")
parser.add_argument(
    "--lambda_b",
    type=float,
    default=5,
    help="The average number of branches per family tree",
)
parser.add_argument(
    "--n_d", type=int, default=2, help="The number of different lengths of descendants"
)
parser.add_argument(
    "--percentages",
    nargs="+",
